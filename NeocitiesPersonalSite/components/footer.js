class PageFooter extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div style="max-width: 100%; padding: 1% 0%; margin: 0%; background-color: #0c335c; font-size:14px;">
            <div style="max-width:100%; margin:0%; padding-left:2%; padding-right: 35%; padding-top:12px; display:flex; justify-content:space-between; align-content:flex-end; flex-wrap:wrap; gap:10%; color:white;">
                ...
                <div style="padding-left:2%; display:flex; flex-direction:column; justify-content: center; align-items:center;">
                    <p style="padding-bottom:12px;">This site is best viewed on Firefox!</p> <br />
                    <h4>SquidInkarus | 2026</h4>
                </div>
                <p></p>
            </div>
        </div>
